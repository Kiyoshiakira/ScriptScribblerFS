  ...
  return (
    <div className={cn('group/block w-full relative', getBlockStyles(block.type, previousBlockType, nextBlockType, isActive))}>
        <button
          ...
          className="absolute -left-6 top-1/2 -translate-y-1/2 p-1 rounded-full bg-destructive/10 hover:bg-destructive/20 text-destructive opacity-0 group-hover/block:opacity-100 transition-opacity z-10"
